-- =============================================
-- Database: formula_jaya_per
-- Sistem Manajemen Bengkel Mobil
-- Formula Jaya Per
-- =============================================

CREATE DATABASE IF NOT EXISTS formula_jaya_per CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE formula_jaya_per;
...
-- Password: admin123
INSERT INTO users (username, password, nama_lengkap, role, email, telepon, status) VALUES
